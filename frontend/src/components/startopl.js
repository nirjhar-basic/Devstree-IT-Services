...
import courseToAction from "./assets/images/call-to-action.png";

const Startopl = () => {
  const [testimonial,setTestimonial]=useState([]);
  useEffect(async()=>{
    const getData=await axios.get('http://localhost:5000/testimonial/getTestimonial');
    setTestimonial(getData)
  },[testimonial])
  return (
    <div>
      {/*====== HEADER PART START ======*/}
      ...
      <section id="call-to-action" className="call-to-action">
        <div className="call-action-image">
          <img src={courseToAction} alt="call-to-action" />
        </div>
